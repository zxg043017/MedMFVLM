...
from LaMed.src.model.Swin_CoCa import CoCa, COCAConfig
...
class ModelArguments:
    ...
    hidden_size: int = field(default=3584)
    ...
    max_text_len: int = field(default=1024)
...
def main():
    ...
    model = M3DCLIP(config).to(torch.bfloat16)
